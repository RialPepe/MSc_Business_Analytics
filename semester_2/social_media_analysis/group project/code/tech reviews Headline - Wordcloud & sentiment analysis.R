...
headline <- tech_data$headline
headline_source <- VectorSource(tech_data$headline)
...
#Word Association 
associations <- findAssocs(pros_tdm, terms = c("place", "best", "experience", "manager", "job",
                                               "engineer", "amazing", "software","people", "culture"), corlimit = 0.2)
associations
