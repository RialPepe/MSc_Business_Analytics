...
cons <- b4_data$cons
cons_source <- VectorSource(b4_data$cons)
...
#Word Association 
associations <- findAssocs(cons_tdm, terms = c("hours", "long", "balance", "pay", "people", "management", "time", "low","salary", "worklife"), corlimit = 0.2)
associations
