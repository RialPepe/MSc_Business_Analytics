...
pros <- tech_data$pros
pros_source <- VectorSource(tech_data$pros)
...
#Word Association 
associations <- findAssocs(pros_tdm, terms = c("benefits", "people", "environment", "culture", "pay",
                                               "smart", "balance", "place","opportunities", "products"), corlimit = 0.2)
associations
